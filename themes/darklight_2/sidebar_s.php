	 ...
	 <h2>SEARCH THIS BLOG</h2>
      <div id="sidebarsearch">
        <form id="searchform" method="get" action="<?php bloginfo('home'); ?>">
          <input type="text" name="s" id="s" size="18" onfocus="if(this.value=='') this.value='';" onblur="if(this.value=='') this.value='Input keywords to search';" value="Input keywords to search"/>
