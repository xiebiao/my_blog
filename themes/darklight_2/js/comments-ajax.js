...
var	ajax_php_url = js_url.replace('js/comments-ajax.js','comments-ajax.php'),				//將 -ajax.js 替換為 -ajax.php, 找到 comments-ajax.php 路徑
		...
		pic_sb_url = wp_url + '/wp-content/themes/darklight_2/images/ajax-loader.gif',			//提交 icon 位址
		pic_no_url = wp_url + '/wp-content/themes/darklight_2/images/no.png', 							//錯誤 icon 位址
		pic_ys_url = wp_url + '/wp-content/themes/darklight_2/images/yes.gif', 						//成功 icon 位址
		txt1 = ' style="display: none;background: url(',							//--------------- 以下是過程所用的 html 字段, 儘量不去動它.
		txt2 = ') no-repeat left;padding-left:20px;color:#A7D86D;',
