<?php
/**
 * WordPress 內置嵌套評論專用 Ajax comments >> WordPress-jQuery-Ajax-Comments v1.2 by Willin Kan.
...
//以下是標準評論式樣, 不含 "回覆":
?>
<li id="comment-<?php comment_ID() ?>" class="comment byuser bypostauthor even thread-even depth-1 parent <?php if($comment->comment_author_email == get_the_author_email()) {echo 'admincom';} else { echo 'regularcom';} ?>">
  <div id="comment-<?php comment_ID() ?>" class="comment-body">
    ...
    <!-- comment-author -->
    <div class="comment-meta commentmetadata"> <span class="commenttime">On
      <?php comment_date('M jS, Y') ?>
      </span> <span class="editpost">
      <?php edit_comment_link('<img alt="Edit" src="' . get_bloginfo('template_directory') . '/images/edit.gif" />', ''); ?>
      </span> </div>
    <div class="clear"></div>
    <!-- comment-meta -->
